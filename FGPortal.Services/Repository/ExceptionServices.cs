...
namespace FGPortal.Services
{
	public class ExceptionServices
	{
        ...
        {
            if (eType.Code == ExceptionTypeCode.Exception_Late.GetKey())
            {
                ...
                {
                    eType.Code = ExceptionTypeCode.Exception_Late1.GetKey();
                ...
                {
                    eType.Code = ExceptionTypeCode.Exception_Late2.GetKey();
                    eType.Description = "Late Exception";
                ...
                {
                    eType.Code = ExceptionTypeCode.Exception_Late3.GetKey();
                    eType.Description = "Late Exception";
        ...
        {
            if (eInfo.Code == ExceptionTypeCode.Exception_Late.GetKey())
            {
                double totalMinutes = timeCompleted.Subtract(timeMax).TotalMinutes;
                ...
                {
                    eInfo.Severity++;
                    eInfo.Code = ExceptionTypeCode.Exception_Late1.GetKey();
                ...
                {
                    eInfo.Severity += 2;
                    eInfo.Code = ExceptionTypeCode.Exception_Late2.GetKey();
                    eInfo.Description = "Late Exception";
                    eInfo.Color = "#FFE08C";
                }
                else if (totalMinutes > (double)result2)
                {
                    eInfo.Severity += 3;
                    eInfo.Code = ExceptionTypeCode.Exception_Late3.GetKey();
                    eInfo.Description = "Late Exception";
                    eInfo.Color = "#FCC2C2";
                }
            }
